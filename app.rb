...
ENV['ORCID_UPDATE_URL'] ||= "https://api.test.datacite.org"
ENV['VOLPINO_URL'] ||= "https://api.test.datacite.org"
ENV['FABRICA_URL'] ||= "https://doi.test.datacite.org"
ENV['DATA_URL'] ||= "https://api.test.datacite.org"
ENV['CDN_URL'] ||= "https://assets.test.datacite.org"
ENV['SITEMAPS_URL'] ||= "https://search.test.datacite.org"
...
get %r{/works/(.+)} do
  ...
  # pagination
  @works[:data] = pagination_helper(Array.wrap(@works[:data]), @page, @works.fetch(:meta, {}).fetch("total", 0))
