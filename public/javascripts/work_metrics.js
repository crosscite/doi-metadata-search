...
$(document).ready(function(e) {
    ...
    var data = gon.chart_views;

    // console.log(gon.chart_views)
    var div = "#visualisation";
    var format = "months";
    var startDate = Date.parse("2018-04-01");
    var endDate = Date.parse("2019-01-01");
    var timeStamp = null;
