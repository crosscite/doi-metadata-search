...
describe "citation" do
  ...
  it "missing DOI" do
    ...
    expect(body).to eq("status"=>"error", "message"=>"DOI missing or wrong format.")
  end
  ...
  it "missing format" do
    ...
    body = JSON.parse(last_response.body)
    expect(body).to eq("status"=>"error", "message"=>"Format missing or not supported.")
  end
