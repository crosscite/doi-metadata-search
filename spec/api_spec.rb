...
describe "API", type: :model, vcr: true do
  ...
  context "get_members" do
    ...
    it "query" do
      ...
      member = response[:data].first
      expect(member).to eq("id"=>"tib", "type"=>"members", "attributes"=>{"title"=>"German National Library of Science and Technology", "description"=>"<p>The TIB is the German National Library for all areas of engineering as well as architecture, chemistry, information technology, mathematics and physics. We are the world&#39;s largest specialised library for science and technology and are part of the German research infrastructure. Our function is the comprehensive procurement and archival storage of technical scientific literature from all over the world. TIB was the first DOI registration agency for primary data worldwide. We have been providing DOI registration services since 2005 and we now work directly with over 40 data centres. TIB is one of the founding members of DataCite and is currently the Business Office. We provide DOI registration services for all German data centres in the fields of engineering, architecture, chemistry, information technology, mathematics and physics. Our current focus is on providing DOI names for primary data and grey literature.</p>\n", "member-type"=>"allocating", "region"=>"EMEA", "country"=>"Germany", "year"=>2009, "logo-url"=>"https://assets.datacite.org/images/members/tib.jpg", "email"=>"doi-info [AT] tib.eu", "website"=>" http://www.tib.eu", "phone"=>"+49 511 762 14226", "updated"=>"2016-06-10T09:56:22.000Z"})
    end
  end
