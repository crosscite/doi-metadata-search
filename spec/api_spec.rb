...
describe "API", type: :model, vcr: true do
  ...
  context "get_contributions" do
    it "all" do
      ...
      expect(contribution["attributes"]["subj-id"]).to eq("http://orcid.org/0000-0003-2337-9984")
    end
